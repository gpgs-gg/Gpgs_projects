          ...
          {menuItems.map(item => {
            ...
            return (
              <button
                ...
                className={`flex items-center space-x-2 px-3 py-2 text-sm font-medium rounded-md sm:rounded-t-lg border-b-2 transition-colors w-full sm:w-auto text-left ${currentView === item.id
