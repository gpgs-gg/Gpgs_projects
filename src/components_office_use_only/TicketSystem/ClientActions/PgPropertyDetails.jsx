                            ...
                            <div className="lg:col-span-2">
                                <div className="bg-white rounded-lg shadow-sm p-6 hover:shadow-md transition-shadow">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                        <div className="md:col-span-3 p-3 bg-orange-50 rounded-lg">
                                        ...
                                        <div className="p-3 bg-orange-50 rounded-lg">
                                            <p className="text-sm text-orange-700 font-medium">Check in Date</p>
                                        ...
                                        <div className="p-3 md:col-span-2 bg-orange-50 rounded-lg">
                                            ...
                                            <div className='grid grid-cols-2 md:grid-cols-3 gap-2 mt-2'>
                                                ...
                                                <div className="p-2 bg-white rounded">
                                                    <p className="text-xs text-orange-600 font-medium">Billing Unit</p>
                                                    <p className="font-medium text-gray-900">15th each month</p>
                                                </div>
                                                <div className="p-2 bg-white rounded">
                                                    <p className="text-xs text-orange-600 font-medium">Power Company Web Link</p>
                                                    <p className="font-medium text-gray-900">15th each month</p>
                                                </div>
                                            </div>
                                        </div>
