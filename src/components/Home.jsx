      ...
      <section id="home" className="gradient-bg flex text-black border py-16 pt-32 lg:min-h-screen">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center  justify-between px-4 sm:px-6 lg:px-8 gap-10">
          ...
          <div className="flex-1 w-full">
            ...
            <Link
              to="/contact"
              className="relative p-3 flex justify-center items-center rounded-full w-[80%] max-w-md mb-8 space-x-2 overflow-hidden group color-flow-bg"
            >
              <p className="text-white capitalize text-base sm:text-md md:text-xl transition-all duration-700 group-hover:mr-4 z-10">
