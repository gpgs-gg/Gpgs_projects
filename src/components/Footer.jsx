  ...
  return (
    <footer className="bg-neutral-900 text-neutral-300 px-6 py-10 ">
      <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
        ...
        {/* Column 1: Brand */}
        <div>
          <h2 className="text-xl font-semibold text-white mb-2">Gopal's Paying Guest Services</h2>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            ...
            <li><Link to="/gpgs-actions/tickets" className="hover:text-white transition">Tickets</Link></li>
          </ul>
        </div>
      ...
      {/* Divider */}
      <div className="border-t border-neutral-700 mt-10 pt-4 text-center text-xs text-neutral-500">
        &copy; {currentYear} PG Management. All rights reserved.
      </div>
    </footer>
  );
};
